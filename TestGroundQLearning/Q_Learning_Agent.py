...
def train(human_f_prop):
    ...
    for episode in range(episodes):
        ...
        while not done: 
            human_robot_dist = np.linalg.norm(env._agent_last_location - env._human_location, ord=1)
            ...
            #print("State: ", (current_human_state,current_agent_state))
